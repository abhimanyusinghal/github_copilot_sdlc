...
_(Same standard as Modules 2–3. Attach to Copilot Chat in VS Code. Code should honour these.)_

- **Performance** — user-facing actions complete in under 2 seconds at P95.
- **Security** — follow OWASP; secrets never in code or prompts; MFA where available;
